...
class Tienda {
    ...
    cargarDatosPrueba() {
        ...
        let libro2 = new LibroPapel(44444, "Titulo 2", [autorPrueba], "Novela", 10.25, 1024, "20x05x50", 1)
        autorPrueba.insertarLibro(libro2);
        this.#libros = new Libros();
        this.#libros.insertarLibros([libro1, libro2]);
    ...
    mostrarCatálogoLibrosDisponibles() {
        //muestra todos los libros disponibles para comprar, separando los ebooks 
        //de los libros en papel.
        let texto = this.#libros.obtenerCadenaLibrosMenu();
        //let opcion = this.#leerDatosPrompt.leerEnteroEntreHasta(texto, 1, this.#libros.libros.length);
    }
